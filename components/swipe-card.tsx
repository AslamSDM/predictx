    ...
    >
      <div className="relative w-full h-full bg-card border border-border rounded-2xl overflow-hidden shadow-2xl">
        ...
        <div className="relative h-full flex flex-col overflow-y-auto">
          {/* Image Section - Now larger if exists */}
          {prediction.tradeImage && (
            <div
              className="relative w-full bg-muted flex-shrink-0"
              style={{ height: "45%" }}
            >
              <Image
              ...
              />
              {/* Image overlay label */}
              <div className="absolute top-2 left-2 bg-black/70 backdrop-blur-sm px-3 py-1 rounded-full text-xs text-white font-medium">
                📊 Trade Chart
              </div>
            </div>
          )}
